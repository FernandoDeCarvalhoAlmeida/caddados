...
public class CalculadoraServiceLocator extends org.apache.axis.client.Service implements calc.CalculadoraService {
    ...
    private java.lang.String Calculadora_address = "http://localhost:8080/calc/services/Calculadora";
    ...
    public calc.Calculadora getCalculadora(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            calc.CalculadoraSoapBindingStub _stub = new calc.CalculadoraSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (calc.Calculadora.class.isAssignableFrom(serviceEndpointInterface)) {
                calc.CalculadoraSoapBindingStub _stub = new calc.CalculadoraSoapBindingStub(new java.net.URL(Calculadora_address), this);
                _stub.setPortName(getCalculadoraWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://calc", "Calculadora"));
        }
